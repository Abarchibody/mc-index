...
define('ENC_KEY', '0d167aa45cb5099fdd9f431ca1c4066b');
define('MP_PARAM_NAME', '__tm_');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '6ccf7670566419a70fa620274410a29f');
define('CHECK_MCPROXY_VALUE', '8c10bef24ed5a03f0759e22aebbda0f1d6e8279963ad633938f9d754896262b8');
